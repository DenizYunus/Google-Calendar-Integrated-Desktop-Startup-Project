...
{
    public class AddTaskHandler : IRequestHandler<AddTaskCommand, CreateResponse<AddTaskResponse>>
    {
        private readonly IJWTHandler _jwtHandler;
        private readonly ITodoService _todoService;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public AddTaskHandler(ITodoService todoService, IHttpContextAccessor httpContextAccessor, IJWTHandler jwtHandler)
        {
            _todoService = todoService;
            _httpContextAccessor = httpContextAccessor;
            _jwtHandler = jwtHandler;
        }
        public async Task<CreateResponse<AddTaskResponse>> Handle(AddTaskCommand command, CancellationToken cancellationToken)
        {
            ...
            return await _todoService.AddTaskAsync(command, claims!);
        }
    }
}
